...
> **Instrucciones:** A la derecha de cada bloque de código, escribe el valor exacto que imprime cada `print()`, en el orden en que aparece. Para los ejercicios de turtle, describe el dibujo resultante.
